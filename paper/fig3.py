"""Figure 3: Entangled spiral Heisenberg chain -- small-runtime accuracy and cascade.

One consistent randomization parameter set for the whole figure: bump window
``lambda = 0.6``, Richardson ratio ``alpha = 1.6456``.
...
cache/fig3.npz: rerunning with unchanged physics parameters (e.g. after a
