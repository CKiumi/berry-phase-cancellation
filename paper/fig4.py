"""Figure 4: End-to-end simulation of the Hadamard-test Berry-phase algorithm.

Runs on the *same problem as Fig. 3* -- the entangled spiral Heisenberg chain
(N = 4, J = 1, B0 = 1) with identical conditions (base runtime T = 20, bump
window lambda = 0.6, Richardson ratio alpha = 1.6456, 30-angle sweep) -- but now
...
and 3, where the interference amplitudes are evaluated exactly.
...
angles and cached in cache/fig4.npz.
"""
...
# Same problem as Fig. 3: the entangled spiral Heisenberg chain, same conditions.
N, J, B0 = 4, 1.0, 1.0
LAM, ALPHA = 0.6, 1.6456
T = 20.0
N_THETA = 30
THETA_C = 0.4 * np.pi
