...
experiments.ipynb   all experiments + figures in one notebook (run top to bottom),
                    with a paper-ready description + caption above every figure:
                    1. spin-1/2 -- (a) Berry-phase validation + (b) cancellation
                       cascade, side by side,
                    2. theory bounds (4 panels: Delta(s), single ~Delta_min,
                       1 Richardson ~Delta(0), 1R+bump Theorem-3 bound),
                    3. many-body spiral chain -- (a) Berry-phase validation +
                       (b) cancellation cascade, side by side
